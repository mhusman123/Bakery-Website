...
export const QUETTA_MAIN_LOCATION: BakeryLocation = {
  ...
  area: 'Jinnah Town',
  displayName: 'QUETTA — JINNAH TOWN',
  image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?q=80&w=600&auto=format&fit=crop',
  address: 'Plot 14-B, Jinnah Town Main Boulevard, Near Serena Gate',
  landmark: 'Opposite Quetta Club / Serena Roundabout',
  city: 'Quetta',
  ...
  googleMapsUrl: 'https://maps.google.com/?q=Jinnah+Town+Quetta+Balochistan+Pakistan',
